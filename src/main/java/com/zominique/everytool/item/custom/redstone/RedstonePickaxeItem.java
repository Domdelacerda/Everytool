...
public class RedstonePickaxeItem extends PickaxeItem implements IRedstoneTool {
    public RedstonePickaxeItem(Item.Properties properties) {
        super(ModToolTiers.REDSTONE, properties.component(
                DataComponents.ATTRIBUTE_MODIFIERS,
                ModToolAttributes.hideDefaultTooltip(ModToolAttributes.pickaxe(ModToolTiers.REDSTONE).build())
        ));
    }
