...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        ...
        buildSmithingTemplateItem(pRecipeOutput, Items.PURPUR_BLOCK, ModItems.CHORUS_UPGRADE_TEMPLATE.get(),
                "has_chorus_upgrade_template");
        buildSmithingTemplateItem(pRecipeOutput, Items.SCULK_CATALYST, ModItems.ECHO_UPGRADE_TEMPLATE.get(),
                "has_echo_upgrade_template");

        smithingUpgrade(pRecipeOutput, ModItems.CHORUS_UPGRADE_TEMPLATE.get(), Items.NETHERITE_SWORD,
                Items.POPPED_CHORUS_FRUIT, ModItems.CHORUS_SWORD.get(), "has_popped_chorus_fruit");
        smithingUpgrade(pRecipeOutput, ModItems.CHORUS_UPGRADE_TEMPLATE.get(), Items.NETHERITE_PICKAXE,
                Items.POPPED_CHORUS_FRUIT, ModItems.CHORUS_PICKAXE.get(), "has_popped_chorus_fruit");
        smithingUpgrade(pRecipeOutput, ModItems.CHORUS_UPGRADE_TEMPLATE.get(), Items.NETHERITE_AXE,
                Items.POPPED_CHORUS_FRUIT, ModItems.CHORUS_AXE.get(), "has_popped_chorus_fruit");
        smithingUpgrade(pRecipeOutput, ModItems.CHORUS_UPGRADE_TEMPLATE.get(), Items.NETHERITE_SHOVEL,
                Items.POPPED_CHORUS_FRUIT, ModItems.CHORUS_SHOVEL.get(), "has_popped_chorus_fruit");
        smithingUpgrade(pRecipeOutput, ModItems.CHORUS_UPGRADE_TEMPLATE.get(), Items.NETHERITE_HOE,
                Items.POPPED_CHORUS_FRUIT, ModItems.CHORUS_HOE.get(), "has_popped_chorus_fruit");

        smithingUpgrade(pRecipeOutput, ModItems.ECHO_UPGRADE_TEMPLATE.get(), ModItems.CHORUS_SWORD.get(),
                Items.ECHO_SHARD, ModItems.ECHO_SWORD.get(), "has_echo_shard");
        smithingUpgrade(pRecipeOutput, ModItems.ECHO_UPGRADE_TEMPLATE.get(), ModItems.CHORUS_PICKAXE.get(),
                Items.ECHO_SHARD, ModItems.ECHO_PICKAXE.get(), "has_echo_shard");
        smithingUpgrade(pRecipeOutput, ModItems.ECHO_UPGRADE_TEMPLATE.get(), ModItems.CHORUS_AXE.get(),
                Items.ECHO_SHARD, ModItems.ECHO_AXE.get(), "has_echo_shard");
        smithingUpgrade(pRecipeOutput, ModItems.ECHO_UPGRADE_TEMPLATE.get(), ModItems.CHORUS_SHOVEL.get(),
                Items.ECHO_SHARD, ModItems.ECHO_SHOVEL.get(), "has_echo_shard");
        smithingUpgrade(pRecipeOutput, ModItems.ECHO_UPGRADE_TEMPLATE.get(), ModItems.CHORUS_HOE.get(),
                Items.ECHO_SHARD, ModItems.ECHO_HOE.get(), "has_echo_shard");
    }
    ...
    private void buildSmithingTemplateItem(RecipeOutput pRecipeOutput, Item item, Item template, String unlockedBy) {
        ResourceLocation id = BuiltInRegistries.ITEM.getKey(template);
        String baseName = id.getPath();
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, template, 2)
                ...
                .unlockedBy(unlockedBy, has(template))
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath
                        (id.getNamespace(), baseName));
    }

    private void smithingUpgrade(RecipeOutput pRecipeOutput, Item template, Item baseEquipment,
                                 Item ingredient, Item resultEquipment, String unlockedBy) {
        SmithingTransformRecipeBuilder.smithing(
                        Ingredient.of(template),
                        Ingredient.of(baseEquipment),
                        Ingredient.of(ingredient),
                        RecipeCategory.TOOLS,
                        resultEquipment
                ).unlocks(unlockedBy, has(ingredient))
                .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(
                        Everytool.MOD_ID, BuiltInRegistries.ITEM.getKey(resultEquipment).getPath() + "_smithing"));
    }
